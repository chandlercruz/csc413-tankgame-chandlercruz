...
public class StartMenuPanel extends JPanel {
    ...
    public StartMenuPanel(Launcher lf) {
        this.lf = lf;
        try {
            menuBackground = ImageIO.read(this.getClass().getClassLoader().getResource("UserInterface/title.png"));
        } catch (IOException e) {
